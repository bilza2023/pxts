import BaseAniProp from "./baseAniProp";
import IdentityFil from "../../animations/filters/identityFil";
import JumpBetween from "../../animations/filters/jumpBetween";
import BaseFilter from "../../animations/filters/baseFilter";
