 ...
 * 
 * During start state : Will return startValue if _animatedValue == null.If and when _animatedValue !== null then _animatedValue is passed out (impl in filterValue).
 */
